...
main(void)
{
    ...
    while(1)
    {
        ...
        {
          GrContextFontSet(&sContext, g_psFontCm12);
          GrStringDrawCentered(&sContext, "button", -1, GrContextDpyWidthGet(&sContext) / 2, 30, 0);
        }
	//
        // Turn on the LED.
        //
        ...
        // Delay for a bit.
        //
        for(ui32Loop = 0; ui32Loop < 2000000 * timerOff; ui32Loop++)
        {
        }
        ...
        // Delay for a bit.
        //
        for(ui32Loop = 0; ui32Loop < 2000000 * timerOn; ui32Loop++)
        {
        }
    }
}
